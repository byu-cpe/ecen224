...
All strings in C end with a null terminator, which has the interger value 0. When C library functions examine or maniuplate a string, it will stop reading when it hits a 0.
